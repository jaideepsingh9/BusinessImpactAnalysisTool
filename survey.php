...
echo $cnt=count($count);
$sql="create table ctr(serial int, selection int)";
$con->query($sql);
$flag=0;
session_start();
$sno=array();
...
while($row=mysqli_fetch_array($r,MYSQLI_NUM)){
	//while($i2<$cnt){
	$flag++;
	$r1=$r2=$r3=$r4=$r5=$r6=$r7=$r8=$r9=$r10=$r11=$r12=$r13=$r14=$r15=$r16=$r17=$r18=$r19=$r20=$r21=$r22=$r23=$r24=$r25=$r26=$r27=$r28=$r29=$r30=$r31=$r32=$r34=$r35=$r36=$r37=$r38=$r39=$r40=null;
		$sel=$_REQUEST['s'];
...
if($sel==1){if($r1==4||$r11==4||$r21==4||$r31==4){
	$_SESSION['sno']=$row[0];
		$_SESSION['sel']=$sel;
		$sql2="insert into ctr values ('$row[0]','$sel') ";
		$con->query($sql2);
...
<?php
$con=mysqli_connect("localhost","root","","ey");
$s=("select Serial_Number, Process from pro");
$r=$con->query($s);
$array=array();
$i=0;
